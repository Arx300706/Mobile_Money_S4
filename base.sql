...
INSERT INTO frais (id, id_operateur, id_type_operations, tranche_min, tranche_max, montant_frais) VALUES
    (1, 1, 1, 0, 10000, 0),
    (2, 1, 1, 10001, 50000, 200),
    (3, 1, 1, 50001, 200000, 500),
    (4, 1, 2, 0, 10000, 300),
    (5, 1, 2, 10001, 50000, 700),
    (6, 1, 2, 50001, 200000, 1500),
    (7, 1, 3, 0, 10000, 200),
    (8, 1, 3, 10001, 50000, 500),
    (9, 1, 3, 50001, 200000, 1200),
    (10, 2, 1, 0, 10000, 0),
    (11, 2, 1, 10001, 50000, 150),
    (12, 2, 1, 50001, 200000, 400),
    (13, 2, 2, 0, 10000, 250),
    (14, 2, 2, 10001, 50000, 650),
    (15, 2, 2, 50001, 200000, 1300),
    (16, 2, 3, 0, 10000, 150),
    (17, 2, 3, 10001, 50000, 450),
    (18, 2, 3, 50001, 200000, 1000),
    (19, 3, 1, 0, 10000, 100),
    (20, 3, 1, 10001, 50000, 250),
    (21, 3, 1, 50001, 200000, 600),
    (22, 3, 2, 0, 10000, 350),
    (23, 3, 2, 10001, 50000, 800),
    (24, 3, 2, 50001, 200000, 1600),
    (25, 3, 3, 0, 10000, 250),
    (26, 3, 3, 10001, 50000, 600),
    (27, 3, 3, 50001, 200000, 1400),
    (28, 4, 1, 0, 10000, 0),
    (29, 4, 1, 10001, 50000, 300),
    (30, 4, 1, 50001, 200000, 700),
    (31, 4, 2, 0, 10000, 400),
    (32, 4, 2, 10001, 50000, 900),
    (33, 4, 2, 50001, 200000, 1800),
    (34, 4, 3, 0, 10000, 300),
    (35, 4, 3, 10001, 50000, 700),
    (36, 4, 3, 50001, 200000, 1500);
